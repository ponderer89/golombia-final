if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            "rtl" === a(document.body).css("direction") && (h = "right" === h ? "left" : "left" === h ? "right" : h);
        ...
        if ("rtl" === document.documentElement.dir) {
            ...
            d.css({
                left: "",
                right: this.options.container ? q : q - (this.$viewport.width() - o.offset().left - o.outerWidth())
            }), delete b.left
        }
...
var audioPlayer = function() {
  ...
  var _elements = {
    ...
    playerButtons: {
      largeToggleBtn: document.querySelector(".large-play-btn"),
  ...
  var _updatePlayStatus = function(audioPlaying) {
    if (audioPlaying) {
      ...
      _elements.playerButtons.largeToggleBtn.children[0].className = "toggle-pause";
      ...
      _elements.playerButtons.largeToggleBtn.children[0].className = "toggle-play";
    ...
    if (_currentTrack === 1) {
      ...
      _elements.playerButtons.previousTrackBtn.disabled = true;
      _elements.playerButtons.previousTrackBtn.className = "previous-track-btn  toggle-btns";
      ...
      _elements.playerButtons.nextTrackBtn.className = "previous-track-btn  toggle-btns";
